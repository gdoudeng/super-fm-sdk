...
- (void)viewDidLoad
{
    ...
    NSLog(@"kCLLocationAccuracyHundredMeters %f", kCLLocationAccuracyHundredMeters);
    NSLog(@"kCLLocationAccuracyKilometer %f", kCLLocationAccuracyKilometer);
    NSLog(@"kCLLocationAccuracyThreeKilometers %f", kCLLocationAccuracyThreeKilometers);
    if (@available(iOS 14.0, *)) {
        NSLog(@"kCLLocationAccuracyReduced %f", kCLLocationAccuracyReduced);
    } else {
